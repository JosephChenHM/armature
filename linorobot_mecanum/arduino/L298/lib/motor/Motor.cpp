...
//Modify here
void Motor::MotorDirectionSet(unsigned char Direction,unsigned char Address)
{   
  //  Adjust the direction of the motors 0b0000 I4 I3 I2 I1     
  Wire.beginTransmission(Address); // transmit to device I2CMotorDriverAdd
...
//Modify here
void Motor::MotorSpeedSetAB(unsigned char MotorSpeedA , unsigned char MotorSpeedB, unsigned char Address)  
{
  //MotorSpeedA=map(MotorSpeedA,0,100,0,255);       
  // Transfer int MotorSpeedA (0-100) to 0-255
