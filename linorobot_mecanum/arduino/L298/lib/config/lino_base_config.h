...
float K_I = 0.04; // I constant
float K_D = 0.6; // D constant
...
const float WHEEL_DIAMETER = 0.06; //wheel's diameter in meters

#define BASE_WIDTH 0.145 // width of the plate you are using
...
#define MOTOR3_ENCODER_A 4 //rear_A
#define MOTOR3_ENCODER_B 5 //rear_B
